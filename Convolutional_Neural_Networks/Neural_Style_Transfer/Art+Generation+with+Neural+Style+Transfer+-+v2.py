...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = 1/(4*n_C*n_C*np.square(n_H*n_W))*tf.reduce_sum(tf.square(tf.subtract(GS,GG)))    
    ### END CODE HERE ###
...
content_image = scipy.misc.imread("images/arg.jpeg")
...
style_image = scipy.misc.imread("images/picaso.jpg")
...
### START CODE HERE ### (1 line)
J = total_cost(J_content, J_style, alpha = 10, beta = 40) #10 40
### END CODE HERE ###
